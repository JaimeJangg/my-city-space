...
import './sectionWaveServices.css'
...
const SectionWave = props => (
    <div className='sectionGroupWaveServices'>
    <h3 className='sectionTitleWaveServices'>{props.title}</h3>
        <div className='waveTopServices'>
            <Wave />
        </div>
        <div className='waveBottomServices'>
            <Wave />
        </div>
